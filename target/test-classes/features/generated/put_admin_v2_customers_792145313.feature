Feature: PUT /admin/v2/customers/792145313
  Background:
    ...
    And I add header "origin" with value 'https://s.beta.salla.group'
    ...
    And I add header "s-store-id" with value '1328842359'
    And I add header "s-store-plan" with value 'special'
    And I add header "s-user-id" with value '69490588'
    ...
    And I add header "sec-fetch-site" with value 'same-site'
